...
export type ProviderChangedHandler = (payload: { provider: Eip1193Provider | null; present: boolean }) => void
...
/**
 * @deprecated Use LoginWithSiweOptions and loginWithSiwe for wallet login.
 * This custom challenge contract will be removed in the next major version.
 */
...
export interface LoginWithSiweOptions extends LoginWithChallengeOptions {
    domain?: string
    uri?: string
...
export type IdentityPresentationScope =
    'identity.basic' | 'identity.wallet' | 'identity.username' | 'identity.email' | 'identity.avatar'
...
export type IdentityPresentationValidationOptions = {
    ...
    trustedIdentityDocument?: Record<string, unknown>
...
export type WalletIdentityLoginOptions = AuthBaseOptions & {
    provider?: Eip1193Provider
    /** Identity scopes requested through the Wallet Identity permission. */
    scopes?: IdentityPresentationScope[]
    address?: string
    sessionPath?: string
    verifyPath?: string
